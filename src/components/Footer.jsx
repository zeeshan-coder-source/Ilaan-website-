...
//   return (
//     <footer
//       className="w-full font-sans relative pt-[40px]"
//       style={{ background: bgGradient || 'linear-gradient(to bottom, #e6fba2 0%, #cdff00 100%)' }}
//     >
//       {/* Background Panel Container */}
//       <div className="relative mx-auto w-[90%] sm:w-[80%] lg:w-[95%] min-h-[600px] lg:min-h-[35vw] xl:min-h-[520px] flex flex-col items-center text-white px-4 sm:px-6 pt-[12%] pb-[14%] lg:pt-[4.5vw] lg:pb-[6.5vw]">
...
//             <img src={moreAttentionImg} alt="More Attention" className="h-[1.8vw] xl:h-[2.2vw] min-h-[22px] max-h-[36px] w-auto object-contain" />
//             <img src={moreSalesImg} alt="More Sales" className="h-[1.8vw] xl:h-[2.2vw] min-h-[22px] max-h-[36px] w-auto object-contain" />
//             <img src={everyDayImg} alt="Every Day" className="h-[1.8vw] xl:h-[2.2vw] min-h-[22px] max-h-[36px] w-auto object-contain" />
//           </div>

//           {/* Main Center Grid */}
//           <div className="grid grid-cols-[1fr_auto_1fr] items-center w-full max-w-[1600px] mx-auto px-[4vw] xl:px-[6vw]">
//             {/* LEFT: Pages */}
//             <div className="flex flex-col items-center pr-[1vw]">
//               <span className="text-[0.6vw] xl:text-[10px] tracking-[0.4em] text-gray-500 font-bold uppercase mb-[1.5vw] xl:mb-4 opacity-60">PAGES</span>
//               <nav className="flex flex-col items-center font-extrabold text-[1.8vw] xl:text-[32px] leading-[1.1] tracking-tighter space-y-0 text-center font-falcon">
//                 <HoverLink text="STUDIO" className="font-falcon" />
//                 <HoverLink text="DIGITAL SIGNAGE" className="font-falcon" />
//                 <HoverLink text="LINK" className="font-falcon" />
//                 <HoverLink text="MEDIA" className="font-falcon" />
//               </nav>
//               <HoverLink text="STORE" className="font-falcon font-bold text-[0.8vw] xl:text-[14px] mt-[1.5vw] xl:mt-6 uppercase tracking-widest" defaultColor="#cdff00" hoverColor="white" />
//             </div>

//             {/* CENTER: Identity */}
//             <div className="flex flex-col items-center justify-center -space-y-[1vw] xl:-space-y-4">
//               <img src={logoIcon} alt="Icon" className="w-[9vw] xl:w-44 h-auto object-contain z-10 drop-shadow-[0_25px_50px_rgba(0,0,0,0.8)]" />
//               <img src={ilanImg} alt="ILAAN" className="w-[13vw] xl:w-[230px] h-auto object-contain select-none" />
//             </div>

//             {/* RIGHT: Socials */}
//             <div className="flex flex-col items-center pl-[1vw]">
//               <span className="text-[0.6vw] xl:text-[10px] tracking-[0.4em] text-gray-500 font-bold uppercase mb-[1.5vw] xl:mb-4 opacity-60">FOLLOW ON</span>
//               <nav className="flex flex-col items-center font-extrabold text-[1.8vw] xl:text-[32px] leading-[1.1] tracking-tighter space-y-0 text-center font-falcon">
//                 <HoverLink text="TIKTOK" className="font-falcon" />
//                 <HoverLink text="INSTAGRAM" className="font-falcon uppercase" />
//                 <HoverLink text="YOUTUBE" className="font-falcon uppercase" />
...
//         {/* Bottom Bar - DESKTOP ONLY (absolute inside container) */}
//         <div className={`hidden lg:flex absolute bottom-[1.0vw] lg:left-[-2.5vw] lg:right-[-1.5vw] xl:left-[0.5vw] xl:right-[1.5vw] flex-row justify-between items-center text-[12px] font-black uppercase tracking-tighter z-20 ${isDark ? 'text-white' : 'text-black'}`}>
//           <div className="opacity-90 text-left">
...
//       {/* Bottom Bar - MOBILE/TABLET ONLY (normal flow outside container) */}
//       <div className={`flex lg:hidden flex-row justify-between items-center px-6 sm:px-10 pb-4 pt-4 text-[10px] font-bold uppercase tracking-normal z-20 ${isDark ? 'text-white' : 'text-black'}`}>
//         <div className="opacity-90 text-left">
//           <BottomHoverLink text="© 2026 Ilaan Limited. All rights reserved" isDark={isDark} />
//         </div>
